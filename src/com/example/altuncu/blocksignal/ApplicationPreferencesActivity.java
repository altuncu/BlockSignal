...
import com.example.altuncu.blocksignal.preferences.AdvancedPreferenceFragment;
import com.example.altuncu.blocksignal.preferences.AppProtectionPreferenceFragment;
import com.example.altuncu.blocksignal.preferences.AppearancePreferenceFragment;
import com.example.altuncu.blocksignal.preferences.ChatsPreferenceFragment;
import com.example.altuncu.blocksignal.preferences.CorrectedPreferenceFragment;
import com.example.altuncu.blocksignal.preferences.NotificationsPreferenceFragment;
import com.example.altuncu.blocksignal.preferences.SmsMmsPreferenceFragment;
import com.example.altuncu.blocksignal.preferences.widgets.ProfilePreference;
        ...
        implements SharedPreferences.OnSharedPreferenceChangeListener
{
  ...
  public static class ApplicationPreferenceFragment extends CorrectedPreferenceFragment {
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, String rootKey) {
      addPreferencesFromResource(com.example.altuncu.blocksignal.R.xml.preferences);
    }
    ...
    public void onResume() {
      super.onResume();
      //noinspection ConstantConditions
      ((ApplicationPreferencesActivity) getActivity()).getSupportActionBar().setTitle(com.example.altuncu.blocksignal.R.string.text_secure_normal__menu_settings);
    ...
    private void tintIcons(Context context) {
      Drawable sms           = DrawableCompat.wrap(ContextCompat.getDrawable(context, com.example.altuncu.blocksignal.R.drawable.ic_textsms_white_24dp));
      Drawable notifications = DrawableCompat.wrap(ContextCompat.getDrawable(context, com.example.altuncu.blocksignal.R.drawable.ic_notifications_white_24dp));
      Drawable privacy       = DrawableCompat.wrap(ContextCompat.getDrawable(context, com.example.altuncu.blocksignal.R.drawable.ic_security_white_24dp));
      Drawable appearance    = DrawableCompat.wrap(ContextCompat.getDrawable(context, com.example.altuncu.blocksignal.R.drawable.ic_brightness_6_white_24dp));
      Drawable chats         = DrawableCompat.wrap(ContextCompat.getDrawable(context, com.example.altuncu.blocksignal.R.drawable.ic_forum_white_24dp));
      Drawable devices       = DrawableCompat.wrap(ContextCompat.getDrawable(context, com.example.altuncu.blocksignal.R.drawable.ic_laptop_white_24dp));
      Drawable advanced      = DrawableCompat.wrap(ContextCompat.getDrawable(context, com.example.altuncu.blocksignal.R.drawable.ic_advanced_white_24dp));

      int[]      tintAttr   = new int[]{com.example.altuncu.blocksignal.R.attr.pref_icon_tint};
