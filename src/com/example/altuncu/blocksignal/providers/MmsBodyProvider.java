...
public class MmsBodyProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://com.example.altuncu.provider.blocksignal.mms/mms";
  ...
  static {
    ...
    uriMatcher.addURI("com.example.altuncu.provider.blocksignal.mms", "mms/#", SINGLE_ROW);
  }
