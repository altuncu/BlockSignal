...
import com.example.altuncu.blocksignal.mms.PartUriParser;
import com.example.altuncu.blocksignal.service.KeyCachingService;
import com.example.altuncu.blocksignal.util.MemoryFileUtil;
...
public class PartProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://com.example.altuncu.provider.blocksignal/part";
  ...
  static {
    ...
    uriMatcher.addURI("com.example.altuncu.provider.blocksignal", "part/*/#", SINGLE_ROW);
  }
