...
import com.example.altuncu.blocksignal.util.PushCharacterCalculator;
import com.example.altuncu.blocksignal.util.SmsCharacterCalculator;
...
public class TransportOptions {
  ...
  private List<TransportOption> initializeAvailableTransports(boolean isMediaMessage) {
    ...
    if (isMediaMessage) {
      results.addAll(getTransportOptionsForSimCards(context.getString(com.example.altuncu.blocksignal.R.string.ConversationActivity_transport_insecure_mms),
                                                    context.getString(com.example.altuncu.blocksignal.R.string.conversation_activity__type_message_mms_insecure),
                                                    new MmsCharacterCalculator()));
    } else {
      results.addAll(getTransportOptionsForSimCards(context.getString(com.example.altuncu.blocksignal.R.string.ConversationActivity_transport_insecure_sms),
                                                    context.getString(com.example.altuncu.blocksignal.R.string.conversation_activity__type_message_sms_insecure),
                                                    new SmsCharacterCalculator()));
    }

    results.add(new TransportOption(Type.TEXTSECURE, com.example.altuncu.blocksignal.R.drawable.ic_send_push_white_24dp,
                                    context.getResources().getColor(com.example.altuncu.blocksignal.R.color.textsecure_primary),
                                    context.getString(com.example.altuncu.blocksignal.R.string.ConversationActivity_transport_signal),
                                    context.getString(com.example.altuncu.blocksignal.R.string.conversation_activity__type_message_push),
                                                                        ...
                                                                        @NonNull CharacterCalculator characterCalculator)
  {
    ...
    if (subscriptions.size() < 2) {
      results.add(new TransportOption(Type.SMS, com.example.altuncu.blocksignal.R.drawable.ic_send_sms_white_24dp,
                                      context.getResources().getColor(com.example.altuncu.blocksignal.R.color.grey_600),
