...
public class MuteDialog extends AlertDialog {
  ...
  public static void show(final Context context, final @NonNull MuteSelectionListener listener) {
    ...
    builder.setTitle(com.example.altuncu.blocksignal.R.string.MuteDialog_mute_notifications);
    builder.setItems(com.example.altuncu.blocksignal.R.array.mute_durations, new DialogInterface.OnClickListener() {
      @Override
