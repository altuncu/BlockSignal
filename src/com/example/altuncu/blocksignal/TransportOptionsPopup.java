...
public class TransportOptionsPopup extends ListPopupWindow implements ListView.OnItemClickListener {
  ...
  public TransportOptionsPopup(@NonNull Context context, @NonNull View anchor, @NonNull SelectedListener listener) {
    ...
    setVerticalOffset(context.getResources().getDimensionPixelOffset(com.example.altuncu.blocksignal.R.dimen.transport_selection_popup_yoff));
    setHorizontalOffset(context.getResources().getDimensionPixelOffset(com.example.altuncu.blocksignal.R.dimen.transport_selection_popup_xoff));
    setInputMethodMode(ListPopupWindow.INPUT_METHOD_NOT_NEEDED);
    setModal(true);
    setAnchorView(anchor);
    setAdapter(adapter);
    setContentWidth(context.getResources().getDimensionPixelSize(com.example.altuncu.blocksignal.R.dimen.transport_selection_popup_width));
