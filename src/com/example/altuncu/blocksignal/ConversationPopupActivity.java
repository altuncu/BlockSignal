...
public class ConversationPopupActivity extends ConversationActivity {
  ...
  protected void onPreCreate() {
    super.onPreCreate();
    overridePendingTransition(com.example.altuncu.blocksignal.R.anim.slide_from_top, com.example.altuncu.blocksignal.R.anim.slide_to_top);
  }
  ...
  protected void onPause() {
    super.onPause();
    if (isFinishing()) overridePendingTransition(com.example.altuncu.blocksignal.R.anim.slide_from_top, com.example.altuncu.blocksignal.R.anim.slide_to_top);
  }
  ...
  public boolean onPrepareOptionsMenu(Menu menu) {
    ...
    inflater.inflate(com.example.altuncu.blocksignal.R.menu.conversation_popup, menu);
    return true;
  }
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    switch (item.getItemId()) {
      case com.example.altuncu.blocksignal.R.id.menu_expand:
        saveDraft().addListener(new ListenableFuture.Listener<Long>() {
          ...
          public void onSuccess(Long result) {
            ...
            if (VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN) {
              ...
              overridePendingTransition(com.example.altuncu.blocksignal.R.anim.fade_scale_in, com.example.altuncu.blocksignal.R.anim.slide_to_right);
            }
