    ...
    implements Button.OnClickListener, ScanListener, DeviceLinkFragment.LinkClickedListener
{
  ...
  public void onCreate(Bundle bundle, boolean ready) {
    ...
    getSupportActionBar().setTitle(com.example.altuncu.blocksignal.R.string.AndroidManifest__linked_devices);
  ...
  public void onClick(View v) {
    Permissions.with(this)
               ...
               .ifNecessary()
               .withPermanentDenialDialog(getString(com.example.altuncu.blocksignal.R.string.DeviceActivity_signal_needs_the_camera_permission_in_order_to_scan_a_qr_code))
               .onAllGranted(() -> {
               ...
               .onAnyDenied(() -> Toast.makeText(this, com.example.altuncu.blocksignal.R.string.DeviceActivity_unable_to_scan_a_qr_code_without_the_camera_permission, Toast.LENGTH_LONG).show())
               .execute();
  }
  ...
  public void onQrDataFound(final String data) {
    Util.runOnMain(() -> {
      ...
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
        deviceAddFragment.setSharedElementReturnTransition(TransitionInflater.from(DeviceActivity.this).inflateTransition(com.example.altuncu.blocksignal.R.transition.fragment_shared));
        ...
        deviceLinkFragment.setSharedElementEnterTransition(TransitionInflater.from(DeviceActivity.this).inflateTransition(com.example.altuncu.blocksignal.R.transition.fragment_shared));
        ...
        getSupportFragmentManager().beginTransaction()
                                   .setCustomAnimations(com.example.altuncu.blocksignal.R.anim.slide_from_bottom, com.example.altuncu.blocksignal.R.anim.slide_to_bottom,
                                                        com.example.altuncu.blocksignal.R.anim.slide_from_bottom, com.example.altuncu.blocksignal.R.anim.slide_to_bottom)
                                   .replace(android.R.id.content, deviceLinkFragment)
                                   .addToBackStack(null)
                                   .commit();
      }
  ...
  public void onLink(final Uri uri) {
    new ProgressDialogAsyncTask<Void, Void, Integer>(this,
                                                     com.example.altuncu.blocksignal.R.string.DeviceProvisioningActivity_content_progress_title,
                                                     com.example.altuncu.blocksignal.R.string.DeviceProvisioningActivity_content_progress_content)
    {
      ...
      protected void onPostExecute(Integer result) {
        ...
        switch (result) {
          case SUCCESS:
            Toast.makeText(context, com.example.altuncu.blocksignal.R.string.DeviceProvisioningActivity_content_progress_success, Toast.LENGTH_SHORT).show();
            finish();
            return;
          case NO_DEVICE:
            Toast.makeText(context, com.example.altuncu.blocksignal.R.string.DeviceProvisioningActivity_content_progress_no_device, Toast.LENGTH_LONG).show();
            break;
          case NETWORK_ERROR:
            Toast.makeText(context, com.example.altuncu.blocksignal.R.string.DeviceProvisioningActivity_content_progress_network_error, Toast.LENGTH_LONG).show();
            break;
          case KEY_ERROR:
            Toast.makeText(context, com.example.altuncu.blocksignal.R.string.DeviceProvisioningActivity_content_progress_key_error, Toast.LENGTH_LONG).show();
            break;
          case LIMIT_EXCEEDED:
            Toast.makeText(context, com.example.altuncu.blocksignal.R.string.DeviceProvisioningActivity_sorry_you_have_too_many_devices_linked_already, Toast.LENGTH_LONG).show();
            break;
          case BAD_CODE:
            Toast.makeText(context, com.example.altuncu.blocksignal.R.string.DeviceActivity_sorry_this_is_not_a_valid_device_link_qr_code, Toast.LENGTH_LONG).show();
            break;
        }
