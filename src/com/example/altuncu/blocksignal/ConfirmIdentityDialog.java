...
import com.example.altuncu.blocksignal.jobs.PushDecryptJob;
...
import com.example.altuncu.blocksignal.util.VerifySpan;
...
public class ConfirmIdentityDialog extends AlertDialog {
                               ...
                               IdentityKeyMismatch mismatch)
  {
    super(context);
      ...
      String          introduction    = String.format(context.getString(com.example.altuncu.blocksignal.R.string.ConfirmIdentityDialog_your_safety_number_with_s_has_changed), name, name);
      SpannableString spannableString = new SpannableString(introduction + " " +
                                                            context.getString(com.example.altuncu.blocksignal.R.string.ConfirmIdentityDialog_you_may_wish_to_verify_your_safety_number_with_this_contact));
      ...
      setButton(AlertDialog.BUTTON_POSITIVE, context.getString(com.example.altuncu.blocksignal.R.string.ConfirmIdentityDialog_accept), new AcceptListener(messageRecord, mismatch, recipient.getAddress()));
