...
import com.example.altuncu.blocksignal.components.RecyclerViewFastScroller;
import com.example.altuncu.blocksignal.contacts.ContactSelectionListAdapter;
import com.example.altuncu.blocksignal.contacts.ContactSelectionListItem;
import com.example.altuncu.blocksignal.contacts.ContactsCursorLoader;
                                          ...
                                          implements LoaderManager.LoaderCallbacks<Cursor>
{
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    View view = inflater.inflate(com.example.altuncu.blocksignal.R.layout.contact_selection_list_fragment, container, false);

    emptyText               = ViewUtil.findById(view, android.R.id.empty);
    recyclerView            = ViewUtil.findById(view, com.example.altuncu.blocksignal.R.id.recycler_view);
    swipeRefresh            = ViewUtil.findById(view, com.example.altuncu.blocksignal.R.id.swipe_refresh);
    fastScroller            = ViewUtil.findById(view, com.example.altuncu.blocksignal.R.id.fast_scroller);
    showContactsLayout      = view.findViewById(com.example.altuncu.blocksignal.R.id.show_contacts_container);
    showContactsButton      = view.findViewById(com.example.altuncu.blocksignal.R.id.show_contacts_button);
    showContactsDescription = view.findViewById(com.example.altuncu.blocksignal.R.id.show_contacts_description);
    showContactsProgress    = view.findViewById(com.example.altuncu.blocksignal.R.id.progress);
  ...
  private void initializeNoContactsPermission() {
    ...
    showContactsDescription.setText(com.example.altuncu.blocksignal.R.string.contact_selection_list_fragment__signal_needs_access_to_your_contacts_in_order_to_display_them);
    ...
    showContactsButton.setOnClickListener(v -> {
      Permissions.with(this)
                 .request(Manifest.permission.WRITE_CONTACTS, Manifest.permission.READ_CONTACTS)
                 .ifNecessary()
                 .withPermanentDenialDialog(getString(com.example.altuncu.blocksignal.R.string.ContactSelectionListFragment_signal_requires_the_contacts_permission_in_order_to_display_your_contacts))
  ...
  public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
    ...
    emptyText.setText(com.example.altuncu.blocksignal.R.string.contact_selection_group_activity__no_contacts);
  ...
  private void handleContactPermissionGranted() {
    new AsyncTask<Void, Void, Boolean>() {
      ...
      protected void onPreExecute() {
        ...
        showContactsDescription.setText(com.example.altuncu.blocksignal.R.string.ConversationListFragment_loading);
      ...
      protected void onPostExecute(Boolean result) {
        if (result) {
          ...
          Toast.makeText(getContext(), com.example.altuncu.blocksignal.R.string.ContactSelectionListFragment_error_retrieving_contacts_check_your_network_connection, Toast.LENGTH_LONG).show();
          initializeNoContactsPermission();
        }
      }
    }.execute();
