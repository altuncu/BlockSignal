...
import com.example.altuncu.blocksignal.IntroPagerAdapter.IntroPage;
...
public class ExperienceUpgradeActivity extends BaseActionBarActivity {
  ...
  private static final String DISMISS_ACTION  = "com.example.altuncu.blocksignal.ExperienceUpgradeActivity.DISMISS_ACTION";
  private static final int    NOTIFICATION_ID = 1339;

  private enum ExperienceUpgrade {
    SIGNAL_REBRANDING(157,
                      new IntroPage(0xFF2090EA,
                                    BasicIntroFragment.newInstance(com.example.altuncu.blocksignal.R.drawable.splash_logo,
                                                                   com.example.altuncu.blocksignal.R.string.ExperienceUpgradeActivity_welcome_to_signal_dgaf,
                                                                   com.example.altuncu.blocksignal.R.string.ExperienceUpgradeActivity_textsecure_is_now_called_signal)),
                      com.example.altuncu.blocksignal.R.string.ExperienceUpgradeActivity_welcome_to_signal_excited,
                      com.example.altuncu.blocksignal.R.string.ExperienceUpgradeActivity_textsecure_is_now_signal,
                      com.example.altuncu.blocksignal.R.string.ExperienceUpgradeActivity_textsecure_is_now_signal_long,
                      null),
    VIDEO_CALLS(245,
                      new IntroPage(0xFF2090EA,
                                    BasicIntroFragment.newInstance(com.example.altuncu.blocksignal.R.drawable.video_splash,
                                                                   com.example.altuncu.blocksignal.R.string.ExperienceUpgradeActivity_say_hello_to_video_calls,
                                                                   com.example.altuncu.blocksignal.R.string.ExperienceUpgradeActivity_signal_now_supports_secure_video_calls)),
                      com.example.altuncu.blocksignal.R.string.ExperienceUpgradeActivity_say_hello_to_video_calls,
                      com.example.altuncu.blocksignal.R.string.ExperienceUpgradeActivity_signal_now_supports_secure_video_calling,
                      com.example.altuncu.blocksignal.R.string.ExperienceUpgradeActivity_signal_now_supports_secure_video_calling_long,
                null),
    PROFILES(286,
                 new IntroPage(0xFF2090EA,
                               BasicIntroFragment.newInstance(com.example.altuncu.blocksignal.R.drawable.profile_splash,
                                                              com.example.altuncu.blocksignal.R.string.ExperienceUpgradeActivity_ready_for_your_closeup,
                                                              com.example.altuncu.blocksignal.R.string.ExperienceUpgradeActivity_now_you_can_share_a_profile_photo_and_name_with_friends_on_signal)),
             com.example.altuncu.blocksignal.R.string.ExperienceUpgradeActivity_signal_profiles_are_here,
             com.example.altuncu.blocksignal.R.string.ExperienceUpgradeActivity_now_you_can_share_a_profile_photo_and_name_with_friends_on_signal,
             com.example.altuncu.blocksignal.R.string.ExperienceUpgradeActivity_now_you_can_share_a_profile_photo_and_name_with_friends_on_signal,
    ...
    READ_RECEIPTS(299,
                  ...
                  com.example.altuncu.blocksignal.R.string.experience_upgrade_preference_fragment__read_receipts_are_here,
                  com.example.altuncu.blocksignal.R.string.experience_upgrade_preference_fragment__optionally_see_and_share_when_messages_have_been_read,
                  com.example.altuncu.blocksignal.R.string.experience_upgrade_preference_fragment__optionally_see_and_share_when_messages_have_been_read,
                  null);
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setStatusBarColor(getResources().getColor(com.example.altuncu.blocksignal.R.color.signal_primary_dark));
    ...
    setContentView(com.example.altuncu.blocksignal.R.layout.experience_upgrade_activity);
    final ViewPager            pager = ViewUtil.findById(this, com.example.altuncu.blocksignal.R.id.pager);
    final FloatingActionButton fab   = ViewUtil.findById(this, com.example.altuncu.blocksignal.R.id.fab);
          ...
          intent.getData().getSchemeSpecificPart().equals(context.getPackageName()))
      {
            ...
            !TextSecurePreferences.isPasswordDisabled(context))
        {
          Notification notification = new NotificationCompat.Builder(context)
              .setSmallIcon(com.example.altuncu.blocksignal.R.drawable.icon_notification)
              .setColor(context.getResources().getColor(com.example.altuncu.blocksignal.R.color.signal_primary))
              .setContentTitle(context.getString(com.example.altuncu.blocksignal.R.string.ExperienceUpgradeActivity_unlock_to_complete_update))
              .setContentText(context.getString(com.example.altuncu.blocksignal.R.string.ExperienceUpgradeActivity_please_unlock_signal_to_complete_update))
              .setStyle(new NotificationCompat.BigTextStyle().bigText(context.getString(com.example.altuncu.blocksignal.R.string.ExperienceUpgradeActivity_please_unlock_signal_to_complete_update)))
              .setAutoCancel(true)
