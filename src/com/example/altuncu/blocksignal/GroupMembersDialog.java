...
public class GroupMembersDialog extends AsyncTask<Void, Void, List<Recipient>> {
  ...
  public void onPostExecute(List<Recipient> members) {
    ...
    builder.setTitle(com.example.altuncu.blocksignal.R.string.ConversationActivity_group_members);
    builder.setIconAttribute(com.example.altuncu.blocksignal.R.attr.group_members_dialog_icon);
  ...
  private class GroupMembers {
    ...
    public String[] getRecipientStrings() {
      ...
      for (Recipient recipient : members) {
        if (isLocalNumber(recipient)) {
          recipientStrings.add(context.getString(com.example.altuncu.blocksignal.R.string.GroupMembersDialog_me));
        } else {
