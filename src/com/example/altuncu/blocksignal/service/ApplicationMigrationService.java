...
import com.example.altuncu.blocksignal.database.SmsMigrator;
    ...
    implements SmsMigrator.SmsMigrationProgressListener
{
  ...
  public  static final String MIGRATE_DATABASE  = "com.example.altuncu.blocksignal.ApplicationMigration.MIGRATE_DATABSE";
  public  static final String COMPLETED_ACTION  = "com.example.altuncu.blocksignal.ApplicationMigrationService.COMPLETED";
