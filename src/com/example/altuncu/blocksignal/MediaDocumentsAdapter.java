...
import com.example.altuncu.blocksignal.MediaDocumentsAdapter.HeaderViewHolder;
import com.example.altuncu.blocksignal.MediaDocumentsAdapter.ViewHolder;
...
import com.example.altuncu.blocksignal.mms.DocumentSlide;
...
public class MediaDocumentsAdapter extends CursorRecyclerViewAdapter<ViewHolder> implements StickyHeaderDecoration.StickyHeaderAdapter<HeaderViewHolder> {
  ...
  public ViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
    return new ViewHolder(LayoutInflater.from(getContext()).inflate(com.example.altuncu.blocksignal.R.layout.media_overview_document_item, parent, false));
  }
    ...
    if (slide != null && slide.hasDocument()) {
      ...
      viewHolder.documentView.setOnClickListener(view -> {
        ...
        try {
          ...
          Toast.makeText(getContext(), com.example.altuncu.blocksignal.R.string.ConversationItem_unable_to_open_media, Toast.LENGTH_LONG).show();
        }
      });
    } else {
  ...
  public HeaderViewHolder onCreateHeaderViewHolder(ViewGroup parent) {
    return new HeaderViewHolder(LayoutInflater.from(getContext()).inflate(com.example.altuncu.blocksignal.R.layout.media_overview_document_item_header, parent, false));
  }
  ...
  public static class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public ViewHolder(View itemView) {
      super(itemView);
      this.documentView = itemView.findViewById(com.example.altuncu.blocksignal.R.id.document_view);
      this.date         = itemView.findViewById(com.example.altuncu.blocksignal.R.id.date);
    }
  }
  ...
  static class HeaderViewHolder extends RecyclerView.ViewHolder {
    ...
    HeaderViewHolder(View itemView) {
      super(itemView);
      this.textView = itemView.findViewById(com.example.altuncu.blocksignal.R.id.text);
    }
  }
