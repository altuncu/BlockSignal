...
class ConversationListAdapter extends CursorRecyclerViewAdapter<ConversationListAdapter.ViewHolder> {
  ...
  public ViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
    if (viewType == MESSAGE_TYPE_SWITCH_ARCHIVE) {
      ConversationListItemAction action = (ConversationListItemAction) inflater.inflate(com.example.altuncu.blocksignal.R.layout.conversation_list_item_action,
                                                                                        parent, false);
      ...
      return new ViewHolder((ConversationListItemInboxZero)inflater.inflate(com.example.altuncu.blocksignal.R.layout.conversation_list_item_inbox_zero, parent, false));
    } else {
      final ConversationListItem item = (ConversationListItem)inflater.inflate(com.example.altuncu.blocksignal.R.layout.conversation_list_item_view,
                                                                               parent, false);
