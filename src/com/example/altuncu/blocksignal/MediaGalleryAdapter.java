...
class MediaGalleryAdapter extends StickyHeaderGridAdapter {
  ...
  private static class ViewHolder extends StickyHeaderGridAdapter.ItemViewHolder {
    ...
    ViewHolder(View v) {
      super(v);
      imageView         = v.findViewById(com.example.altuncu.blocksignal.R.id.image);
      selectedIndicator = v.findViewById(com.example.altuncu.blocksignal.R.id.selected_indicator);
    }
  }
  ...
  private static class HeaderHolder extends StickyHeaderGridAdapter.HeaderViewHolder {
    ...
    HeaderHolder(View itemView) {
      super(itemView);
      textView = itemView.findViewById(com.example.altuncu.blocksignal.R.id.text);
    }
  }
  ...
  public StickyHeaderGridAdapter.HeaderViewHolder onCreateHeaderViewHolder(ViewGroup parent, int headerType) {
    return new HeaderHolder(LayoutInflater.from(context).inflate(com.example.altuncu.blocksignal.R.layout.media_overview_gallery_item_header, parent, false));
  }

  @Override
  public ItemViewHolder onCreateItemViewHolder(ViewGroup parent, int itemType) {
    return new ViewHolder(LayoutInflater.from(context).inflate(com.example.altuncu.blocksignal.R.layout.media_overview_gallery_item, parent, false));
  }
