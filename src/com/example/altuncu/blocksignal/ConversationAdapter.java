...
import com.example.altuncu.blocksignal.database.FastCursorRecyclerViewAdapter;
...
import com.example.altuncu.blocksignal.util.LRUCache;
  ...
  implements StickyHeaderDecoration.StickyHeaderAdapter<HeaderViewHolder>
{
  ...
  static class HeaderViewHolder extends RecyclerView.ViewHolder {
    ...
    HeaderViewHolder(View itemView) {
      super(itemView);
      textView = ViewUtil.findById(itemView, com.example.altuncu.blocksignal.R.id.text);
    }
  ...
  private @LayoutRes int getLayoutForViewType(int viewType) {
    switch (viewType) {
      ...
      case MESSAGE_TYPE_OUTGOING:        return com.example.altuncu.blocksignal.R.layout.conversation_item_sent;
      case MESSAGE_TYPE_AUDIO_INCOMING:
      case MESSAGE_TYPE_THUMBNAIL_INCOMING:
      case MESSAGE_TYPE_DOCUMENT_INCOMING:
      case MESSAGE_TYPE_INCOMING:        return com.example.altuncu.blocksignal.R.layout.conversation_item_received;
      case MESSAGE_TYPE_UPDATE:          return com.example.altuncu.blocksignal.R.layout.conversation_item_update;
  ...
  public HeaderViewHolder onCreateHeaderViewHolder(ViewGroup parent) {
    return new HeaderViewHolder(LayoutInflater.from(getContext()).inflate(com.example.altuncu.blocksignal.R.layout.conversation_item_header, parent, false));
  }

  public HeaderViewHolder onCreateLastSeenViewHolder(ViewGroup parent) {
    return new HeaderViewHolder(LayoutInflater.from(getContext()).inflate(com.example.altuncu.blocksignal.R.layout.conversation_item_last_seen, parent, false));
  }
  ...
  public void onBindLastSeenViewHolder(HeaderViewHolder viewHolder, int position) {
    viewHolder.setText(getContext().getResources().getQuantityString(com.example.altuncu.blocksignal.R.plurals.ConversationAdapter_n_unread_messages, (position + 1), (position + 1)));
  }
