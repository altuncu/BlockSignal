...
import com.example.altuncu.blocksignal.components.FromTextView;
...
import static com.example.altuncu.blocksignal.util.SpanUtil.color;
                                             ...
                                             BindableConversationListItem, Unbindable
{
  ...
  protected void onFinishInflate() {
    ...
    this.subjectView             = findViewById(com.example.altuncu.blocksignal.R.id.subject);
    this.fromView                = findViewById(com.example.altuncu.blocksignal.R.id.from);
    this.dateView                = findViewById(com.example.altuncu.blocksignal.R.id.date);
    ...
    this.contactPhotoImage       = findViewById(com.example.altuncu.blocksignal.R.id.contact_photo_image);
    this.thumbnailView           = findViewById(com.example.altuncu.blocksignal.R.id.thumbnail);
    this.archivedView            = findViewById(com.example.altuncu.blocksignal.R.id.archived);
    this.unreadIndicator         = findViewById(com.example.altuncu.blocksignal.R.id.unread_indicator);
...
//    this.subjectView.setTypeface(read ? LIGHT_TYPEFACE : BOLD_TYPEFACE);
    ...
    if (thread.getDate() > 0) {
      ...
      dateView.setText(unreadCount == 0 ? date : color(getResources().getColor(com.example.altuncu.blocksignal.R.color.textsecure_primary_dark), date));
  ...
  private void setThumbnailSnippet(ThreadRecord thread) {
    if (thread.getSnippetUri() != null) {
      ...
      subjectParams.addRule(RelativeLayout.LEFT_OF, com.example.altuncu.blocksignal.R.id.thumbnail);
      if (VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN_MR1) {
        subjectParams.addRule(RelativeLayout.START_OF, com.example.altuncu.blocksignal.R.id.thumbnail);
      }
      ...
      LayoutParams subjectParams = (RelativeLayout.LayoutParams)this.subjectView.getLayoutParams();
      subjectParams.addRule(RelativeLayout.LEFT_OF, com.example.altuncu.blocksignal.R.id.status);
      if (VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN_MR1) {
        subjectParams.addRule(RelativeLayout.START_OF, com.example.altuncu.blocksignal.R.id.status);
      }
      this.subjectView.setLayoutParams(subjectParams);
    }
  }
  ...
  private void setUnreadIndicator(ThreadRecord thread) {
    ...
    unreadIndicator.setImageDrawable(TextDrawable.builder()
                                                 ...
                                                 .bold()
                                                 .endConfig()
                                                 .buildRound(String.valueOf(thread.getUnreadCount()), getResources().getColor(com.example.altuncu.blocksignal.R.color.textsecure_primary_dark)));
  ...
  private static class ThumbnailPositioner implements Runnable {
    ...
    public void run() {
      ...
      {
        thumbnailParams.addRule(RelativeLayout.LEFT_OF, com.example.altuncu.blocksignal.R.id.status);
        if (VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN_MR1) {
          thumbnailParams.addRule(RelativeLayout.START_OF, com.example.altuncu.blocksignal.R.id.status);
        }
      } else {
        thumbnailParams.addRule(RelativeLayout.LEFT_OF, com.example.altuncu.blocksignal.R.id.date);
        if (VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN_MR1) {
          thumbnailParams.addRule(RelativeLayout.START_OF, com.example.altuncu.blocksignal.R.id.date);
        }
      }
