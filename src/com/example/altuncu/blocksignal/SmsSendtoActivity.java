...
import com.example.altuncu.blocksignal.util.Rfc5724Uri;
...
public class SmsSendtoActivity extends Activity {
  ...
  private Intent getNextIntent(Intent original) {
    ...
    if (TextUtils.isEmpty(destination.destination)) {
      ...
      Toast.makeText(this, com.example.altuncu.blocksignal.R.string.ConversationActivity_specify_recipient, Toast.LENGTH_LONG).show();
    } else {
