...
public class NewConversationActivity extends ContactSelectionActivity {
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    case com.example.altuncu.blocksignal.R.id.menu_refresh:   handleManualRefresh(); return true;
    case com.example.altuncu.blocksignal.R.id.menu_new_group: handleCreateGroup();   return true;
  ...
  protected boolean onPrepareOptionsPanel(View view, Menu menu) {
    ...
    menu.clear();
    inflater.inflate(com.example.altuncu.blocksignal.R.menu.new_conversation_activity, menu);
