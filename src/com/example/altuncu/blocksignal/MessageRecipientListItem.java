    ...
    implements RecipientModifiedListener
{
  ...
  protected void onFinishInflate() {
    ...
    this.errorDescription   = findViewById(com.example.altuncu.blocksignal.R.id.error_description);
    this.actionDescription  = findViewById(com.example.altuncu.blocksignal.R.id.action_description);
    this.contactPhotoImage  = findViewById(com.example.altuncu.blocksignal.R.id.contact_photo_image);
    this.conflictButton     = findViewById(com.example.altuncu.blocksignal.R.id.conflict_button);
    this.resendButton       = findViewById(com.example.altuncu.blocksignal.R.id.resend_button);
    this.deliveryStatusView = findViewById(com.example.altuncu.blocksignal.R.id.delivery_status);
  }
                                  ...
                                  final boolean isPushGroup)
  {
    ...
    if (keyMismatch != null) {
      ...
      errorText = getContext().getString(com.example.altuncu.blocksignal.R.string.MessageDetailsRecipient_new_safety_number);
      ...
      errorText = getContext().getString(com.example.altuncu.blocksignal.R.string.MessageDetailsRecipient_failed_to_send);
      resendButton.setOnClickListener(v -> {
        resendButton.setVisibility(View.GONE);
        errorDescription.setVisibility(View.GONE);
        actionDescription.setVisibility(View.VISIBLE);
        actionDescription.setText(com.example.altuncu.blocksignal.R.string.message_recipients_list_item__resending);
