...
import com.example.altuncu.blocksignal.database.SmsMigrator.ProgressDescription;
import com.example.altuncu.blocksignal.service.ApplicationMigrationService;
import com.example.altuncu.blocksignal.service.ApplicationMigrationService.ImportState;
...
public class DatabaseMigrationActivity extends PassphraseRequiredActionBarActivity {
  ...
  protected void onCreate(Bundle bundle, boolean ready) {
    setContentView(com.example.altuncu.blocksignal.R.layout.database_migration_activity);
  ...
  private void initializeResources() {
    this.promptLayout   = (LinearLayout)findViewById(com.example.altuncu.blocksignal.R.id.prompt_layout);
    this.progressLayout = (LinearLayout)findViewById(com.example.altuncu.blocksignal.R.id.progress_layout);
    this.skipButton     = (Button)      findViewById(com.example.altuncu.blocksignal.R.id.skip_button);
    this.importButton   = (Button)      findViewById(com.example.altuncu.blocksignal.R.id.import_button);
    this.progress       = (ProgressBar) findViewById(com.example.altuncu.blocksignal.R.id.import_progress);
    this.progressLabel  = (TextView)    findViewById(com.example.altuncu.blocksignal.R.id.import_status);
