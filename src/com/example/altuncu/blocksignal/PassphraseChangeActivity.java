...
public class PassphraseChangeActivity extends PassphraseActivity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(com.example.altuncu.blocksignal.R.layout.change_passphrase_activity);
  ...
  private void initializeResources() {
    this.originalPassphrase      = (EditText) findViewById(com.example.altuncu.blocksignal.R.id.old_passphrase      );
    this.newPassphrase           = (EditText) findViewById(com.example.altuncu.blocksignal.R.id.new_passphrase      );
    this.repeatPassphrase        = (EditText) findViewById(com.example.altuncu.blocksignal.R.id.repeat_passphrase   );

    this.okButton                = (Button  ) findViewById(com.example.altuncu.blocksignal.R.id.ok_button           );
    this.cancelButton            = (Button  ) findViewById(com.example.altuncu.blocksignal.R.id.cancel_button       );
  ...
  private void verifyAndSavePassphrases() {
    ...
    if (!passphrase.equals(passphraseRepeat)) {
      ...
      this.newPassphrase.setError(getString(com.example.altuncu.blocksignal.R.string.PassphraseChangeActivity_passphrases_dont_match_exclamation));
      this.newPassphrase.requestFocus();
    } else if (passphrase.equals("")) {
      this.newPassphrase.setError(getString(com.example.altuncu.blocksignal.R.string.PassphraseChangeActivity_enter_new_passphrase_exclamation));
      this.newPassphrase.requestFocus();
    } else {
  ...
  private class ChangePassphraseTask extends AsyncTask<String, Void, MasterSecret> {
    ...
    protected void onPostExecute(MasterSecret masterSecret) {
      ...
      if (masterSecret != null) {
        ...
        originalPassphrase.setError(getString(com.example.altuncu.blocksignal.R.string.PassphraseChangeActivity_incorrect_old_passphrase_exclamation));
