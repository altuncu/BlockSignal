...
import com.example.altuncu.blocksignal.database.model.SmsMessageRecord;
import com.example.altuncu.blocksignal.jobs.TrimThreadJob;
import com.example.altuncu.blocksignal.recipients.Recipient;
import com.example.altuncu.blocksignal.sms.IncomingGroupMessage;
...
public class SmsDatabase extends MessagingDatabase {
  ...
  protected Optional<InsertResult> insertMessageInbox(IncomingTextMessage message, long type) {
    ...
    boolean    unread     = (com.example.altuncu.blocksignal.util.Util.isDefaultSmsProvider(context) ||
