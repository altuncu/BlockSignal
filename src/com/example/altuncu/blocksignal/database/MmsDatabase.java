...
import com.example.altuncu.blocksignal.attachments.MmsNotificationAttachment;
...
import com.example.altuncu.blocksignal.database.documents.IdentityKeyMismatchList;
import com.example.altuncu.blocksignal.database.documents.NetworkFailure;
import com.example.altuncu.blocksignal.database.documents.NetworkFailureList;
...
import com.example.altuncu.blocksignal.database.model.NotificationMmsMessageRecord;
import com.example.altuncu.blocksignal.database.model.Quote;
import com.example.altuncu.blocksignal.jobs.TrimThreadJob;
import com.example.altuncu.blocksignal.mms.IncomingMediaMessage;
...
//  }
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (com.example.altuncu.blocksignal.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).incrementUnread(threadId, 1);
    }
  ...
  public class Reader {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = com.example.altuncu.blocksignal.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = com.example.altuncu.blocksignal.util.Util.toIsoBytes(transactionId);
