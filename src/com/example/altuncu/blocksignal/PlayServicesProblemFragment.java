  ...
  public @NonNull Dialog onCreateDialog(@NonNull Bundle bundle) {
    ...
    if (dialog == null) {
      return new AlertDialog.Builder(getActivity())
              ...
              .setMessage(com.example.altuncu.blocksignal.R.string.PlayServicesProblemFragment_the_version_of_google_play_services_you_have_installed_is_not_functioning)
              .create();
    } else {
      return dialog;
    }
