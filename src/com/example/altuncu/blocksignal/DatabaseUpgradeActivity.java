...
import com.example.altuncu.blocksignal.database.MmsDatabase.Reader;
...
public class DatabaseUpgradeActivity extends BaseActivity {
  ...
  public void onCreate(Bundle bundle) {
    ...
    if (needsUpgradeTask()) {
      ...
      setContentView(com.example.altuncu.blocksignal.R.layout.database_upgrade_activity);

      ProgressBar indeterminateProgress = findViewById(com.example.altuncu.blocksignal.R.id.indeterminate_progress);
      ProgressBar determinateProgress   = findViewById(com.example.altuncu.blocksignal.R.id.determinate_progress);
