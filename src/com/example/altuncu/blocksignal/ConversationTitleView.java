...
public class ConversationTitleView extends RelativeLayout {
  ...
  public void onFinishInflate() {
    ...
    this.back     = ViewUtil.findById(this, com.example.altuncu.blocksignal.R.id.up_button);
    this.content  = ViewUtil.findById(this, com.example.altuncu.blocksignal.R.id.content);
    this.title    = ViewUtil.findById(this, com.example.altuncu.blocksignal.R.id.title);
    this.subtitle = ViewUtil.findById(this, com.example.altuncu.blocksignal.R.id.subtitle);
    this.verified = ViewUtil.findById(this, com.example.altuncu.blocksignal.R.id.verified_indicator);
    this.avatar   = ViewUtil.findById(this, com.example.altuncu.blocksignal.R.id.contact_photo_image);
  ...
  public void setTitle(@NonNull GlideRequests glideRequests, @Nullable Recipient recipient) {
    ...
    if (recipient != null && recipient.isBlocked()) {
      title.setCompoundDrawablesWithIntrinsicBounds(com.example.altuncu.blocksignal.R.drawable.ic_block_white_18dp, 0, 0, 0);
    } else if (recipient != null && recipient.isMuted()) {
      title.setCompoundDrawablesWithIntrinsicBounds(com.example.altuncu.blocksignal.R.drawable.ic_volume_off_white_18dp, 0, 0, 0);
    } else {
  ...
  private void setComposeTitle() {
    this.title.setText(com.example.altuncu.blocksignal.R.string.ConversationActivity_compose_message);
