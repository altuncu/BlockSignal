...
import com.example.altuncu.blocksignal.backup.FullBackupBase;
import com.example.altuncu.blocksignal.backup.FullBackupImporter;
import com.example.altuncu.blocksignal.components.registration.CallMeCountDownView;
import com.example.altuncu.blocksignal.components.registration.VerificationCodeView;
import com.example.altuncu.blocksignal.components.registration.VerificationPinKeyboard;
...
import com.example.altuncu.blocksignal.lock.RegistrationLockReminders;
import com.example.altuncu.blocksignal.permissions.Permissions;
import com.example.altuncu.blocksignal.push.AccountManagerFactory;
import com.example.altuncu.blocksignal.service.DirectoryRefreshListener;
import com.example.altuncu.blocksignal.service.RotateSignedPreKeyListener;
...
import com.example.altuncu.blocksignal.util.PlayServicesUtil;
import com.example.altuncu.blocksignal.util.PlayServicesUtil.PlayServicesStatus;
...
public class RegistrationActivity extends BaseActionBarActivity implements VerificationCodeView.OnCodeEnteredListener {
  ...
  public static final  String CHALLENGE_EVENT           = "com.example.altuncu.blocksignal.CHALLENGE_EVENT";
  ...
  public void onCreate(Bundle icicle) {
    ...
    setContentView(com.example.altuncu.blocksignal.R.layout.registration_activity);
  ...
  private void initializeResources() {
    TextView skipButton        = findViewById(com.example.altuncu.blocksignal.R.id.skip_button);
    TextView restoreSkipButton = findViewById(com.example.altuncu.blocksignal.R.id.skip_restore_button);
    View     informationToggle = findViewById(com.example.altuncu.blocksignal.R.id.information_link_container);

    this.countrySpinner        = findViewById(com.example.altuncu.blocksignal.R.id.country_spinner);
    this.countryCode           = findViewById(com.example.altuncu.blocksignal.R.id.country_code);
    this.number                = findViewById(com.example.altuncu.blocksignal.R.id.number);
    this.createButton          = findViewById(com.example.altuncu.blocksignal.R.id.registerButton);
    this.informationView       = findViewById(com.example.altuncu.blocksignal.R.id.registration_information);
    this.informationToggleText = findViewById(com.example.altuncu.blocksignal.R.id.information_label);
    this.title                 = findViewById(com.example.altuncu.blocksignal.R.id.verify_header);
    this.subtitle              = findViewById(com.example.altuncu.blocksignal.R.id.verify_subheader);
    this.registrationContainer = findViewById(com.example.altuncu.blocksignal.R.id.registration_container);
    this.verificationContainer = findViewById(com.example.altuncu.blocksignal.R.id.verification_container);
    this.fab                   = findViewById(com.example.altuncu.blocksignal.R.id.fab);

    this.verificationCodeView = findViewById(com.example.altuncu.blocksignal.R.id.code);
    this.keyboard             = findViewById(com.example.altuncu.blocksignal.R.id.keyboard);
    this.callMeCountDownView  = findViewById(com.example.altuncu.blocksignal.R.id.call_me_count_down);

    this.restoreContainer      = findViewById(com.example.altuncu.blocksignal.R.id.restore_container);
    this.restoreBackupSize     = findViewById(com.example.altuncu.blocksignal.R.id.backup_size_text);
    this.restoreBackupTime     = findViewById(com.example.altuncu.blocksignal.R.id.backup_created_text);
    this.restoreBackupProgress = findViewById(com.example.altuncu.blocksignal.R.id.backup_progress_text);
    this.restoreButton         = findViewById(com.example.altuncu.blocksignal.R.id.restore_button);

    this.pinContainer              = findViewById(com.example.altuncu.blocksignal.R.id.pin_container);
    this.pin                       = findViewById(com.example.altuncu.blocksignal.R.id.pin);
    this.pinButton                 = findViewById(com.example.altuncu.blocksignal.R.id.pinButton);
    this.pinForgotButton           = findViewById(com.example.altuncu.blocksignal.R.id.forgot_button);
    this.pinClarificationContainer = findViewById(com.example.altuncu.blocksignal.R.id.pin_clarification_container);
  ...
  private void initializeSpinner() {
    ...
    setCountryDisplay(getString(com.example.altuncu.blocksignal.R.string.RegistrationActivity_select_your_country));
  ...
  private void initializePermissions() {
    Permissions.with(RegistrationActivity.this)
               ...
               .ifNecessary()
               .withRationaleDialog(getString(com.example.altuncu.blocksignal.R.string.RegistrationActivity_signal_needs_access_to_your_contacts_and_media_in_order_to_connect_with_friends),
                                    com.example.altuncu.blocksignal.R.drawable.ic_contacts_white_48dp, com.example.altuncu.blocksignal.R.drawable.ic_folder_white_48dp)
  ...
  private void handleRestore(BackupUtil.BackupInfo backup) {
    View     view   = LayoutInflater.from(this).inflate(com.example.altuncu.blocksignal.R.layout.enter_backup_passphrase_dialog, null);
    EditText prompt = view.findViewById(com.example.altuncu.blocksignal.R.id.restore_passphrase_input);

    new AlertDialog.Builder(this)
        .setTitle(com.example.altuncu.blocksignal.R.string.RegistrationActivity_enter_backup_passphrase)
        .setView(view)
        .setPositiveButton(getString(com.example.altuncu.blocksignal.R.string.RegistrationActivity_restore), (dialog, which) -> {
          ...
          new AsyncTask<Void, Void, Boolean>() {
            ...
            protected void onPostExecute(@NonNull Boolean result) {
              ...
              if (result) {
                ...
                Toast.makeText(RegistrationActivity.this, com.example.altuncu.blocksignal.R.string.RegistrationActivity_incorrect_backup_passphrase, Toast.LENGTH_LONG).show();
              }
            }
          }.execute();
  ...
  private void handleRegister() {
    if (TextUtils.isEmpty(countryCode.getText())) {
      Toast.makeText(this, getString(com.example.altuncu.blocksignal.R.string.RegistrationActivity_you_must_specify_your_country_code), Toast.LENGTH_LONG).show();
      return;
    }

    if (TextUtils.isEmpty(number.getText())) {
      Toast.makeText(this, getString(com.example.altuncu.blocksignal.R.string.RegistrationActivity_you_must_specify_your_phone_number), Toast.LENGTH_LONG).show();
      return;
    }
    ...
    Permissions.with(this)
               ...
               .ifNecessary()
               .withRationaleDialog(getString(com.example.altuncu.blocksignal.R.string.RegistrationActivity_to_easily_verify_your_phone_number_signal_can_automatically_detect_your_verification_code), com.example.altuncu.blocksignal.R.drawable.ic_textsms_white_48dp)
  ...
  private void handleRegisterWithPermissions() {
    ...
    if (!PhoneNumberFormatter.isValidNumber(e164number)) {
      Dialogs.showAlertDialog(this, getString(com.example.altuncu.blocksignal.R.string.RegistrationActivity_invalid_number),
                              String.format(getString(com.example.altuncu.blocksignal.R.string.RegistrationActivity_the_number_you_specified_s_is_invalid),
                                            e164number));
      return;
    }
    ...
    if (gcmStatus == PlayServicesStatus.SUCCESS) {
      ...
      Dialogs.showAlertDialog(this, getString(com.example.altuncu.blocksignal.R.string.RegistrationActivity_play_services_error),
                              getString(com.example.altuncu.blocksignal.R.string.RegistrationActivity_google_play_services_is_updating_or_unavailable));
    }
  }
  ...
  private void handleRequestVerification(@NonNull String e164number, boolean gcmSupported) {
    ...
    new AsyncTask<Void, Void, Pair<String, Optional<String>>> () {
      ...
      protected void onPostExecute(@Nullable Pair<String, Optional<String>> result) {
        if (result == null) {
          Toast.makeText(RegistrationActivity.this, com.example.altuncu.blocksignal.R.string.RegistrationActivity_unable_to_connect_to_service, Toast.LENGTH_LONG).show();
          return;
        }
  ...
  private void handleVerifyWithPinClicked(@NonNull String code, @Nullable String pin) {
    if (TextUtils.isEmpty(pin) || TextUtils.isEmpty(pin.replace(" ", ""))) {
      Toast.makeText(this, com.example.altuncu.blocksignal.R.string.RegistrationActivity_you_must_enter_your_registration_lock_PIN, Toast.LENGTH_LONG).show();
      return;
    }
    ...
    new AsyncTask<Void, Void, Integer>() {
      ...
      protected void onPostExecute(Integer result) {
        ...
        if (result == 1) {
          ...
          Toast.makeText(RegistrationActivity.this, com.example.altuncu.blocksignal.R.string.RegistrationActivity_incorrect_registration_lock_pin, Toast.LENGTH_LONG).show();
        } else if (result == 3) {
          new AlertDialog.Builder(RegistrationActivity.this)
                         .setTitle(com.example.altuncu.blocksignal.R.string.RegistrationActivity_too_many_attempts)
                         .setMessage(com.example.altuncu.blocksignal.R.string.RegistrationActivity_you_have_made_too_many_incorrect_registration_lock_pin_attempts_please_try_again_in_a_day)
                         .setPositiveButton(android.R.string.ok, null)
                         .show();
        } else if (result == 4) {
          Toast.makeText(RegistrationActivity.this, com.example.altuncu.blocksignal.R.string.RegistrationActivity_error_connecting_to_service, Toast.LENGTH_LONG).show();
        }
      }
    }.execute();
  }
  ...
  private void handleForgottenPin(long timeRemaining) {
    new AlertDialog.Builder(RegistrationActivity.this)
        .setTitle(com.example.altuncu.blocksignal.R.string.RegistrationActivity_oh_no)
        .setMessage(getString(com.example.altuncu.blocksignal.R.string.RegistrationActivity_registration_of_this_phone_number_will_be_possible_without_your_registration_lock_pin_after_seven_days_have_passed, (TimeUnit.MILLISECONDS.toDays(timeRemaining) + 1)))
        .setPositiveButton(android.R.string.ok, null)
        .show();
  }
  ...
  private void displayRestoreView(@NonNull BackupUtil.BackupInfo backup) {
    title.animate().translationX(title.getWidth()).setDuration(SCENE_TRANSITION_DURATION).setListener(new AnimationCompleteListener() {
      ...
      public void onAnimationEnd(Animator animation) {
        title.setText(com.example.altuncu.blocksignal.R.string.RegistrationActivity_restore_from_backup);
    ...
    subtitle.animate().translationX(subtitle.getWidth()).setDuration(SCENE_TRANSITION_DURATION).setListener(new AnimationCompleteListener() {
      @Override
      public void onAnimationEnd(Animator animation) {
        subtitle.setText(com.example.altuncu.blocksignal.R.string.RegistrationActivity_restore_your_messages_and_media_from_a_local_backup);
    ...
    registrationContainer.animate().translationX(registrationContainer.getWidth()).setDuration(SCENE_TRANSITION_DURATION).setListener(new AnimationCompleteListener() {
      ...
      public void onAnimationEnd(Animator animation) {
        ...
        restoreBackupSize.setText(getString(com.example.altuncu.blocksignal.R.string.RegistrationActivity_backup_size_s, Util.getPrettyFileSize(backup.getSize())));
        restoreBackupTime.setText(getString(com.example.altuncu.blocksignal.R.string.RegistrationActivity_backup_timestamp_s, DateUtils.getExtendedRelativeTimeSpanString(RegistrationActivity.this, Locale.US, backup.getTimestamp())));
        restoreBackupProgress.setText("");
    ...
    fab.animate().rotationBy(375f).setDuration(SCENE_TRANSITION_DURATION).setListener(new AnimationCompleteListener() {
      ...
      public void onAnimationEnd(Animator animation) {
        fab.clearAnimation();
        fab.setImageResource(com.example.altuncu.blocksignal.R.drawable.ic_restore_white_24dp);
  ...
  private void displayInitialView(boolean forwards) {
    ...
    title.animate().translationX(startDirectionMultiplier * title.getWidth()).setDuration(SCENE_TRANSITION_DURATION).setListener(new AnimationCompleteListener() {
      @Override
      public void onAnimationEnd(Animator animation) {
        title.setText(com.example.altuncu.blocksignal.R.string.registration_activity__verify_your_number);
        title.clearAnimation();
    ...
    subtitle.animate().translationX(startDirectionMultiplier * subtitle.getWidth()).setDuration(SCENE_TRANSITION_DURATION).setListener(new AnimationCompleteListener() {
      @Override
      public void onAnimationEnd(Animator animation) {
        subtitle.setText(com.example.altuncu.blocksignal.R.string.registration_activity__please_enter_your_mobile_number_to_receive_a_verification_code_carrier_rates_may_apply);
        subtitle.clearAnimation();
    ...
    fab.animate().rotationBy(startDirectionMultiplier * 360f).setDuration(SCENE_TRANSITION_DURATION).setListener(new AnimationCompleteListener() {
      ...
      public void onAnimationEnd(Animator animation) {
        fab.clearAnimation();
        fab.setImageResource(com.example.altuncu.blocksignal.R.drawable.ic_action_name);
  ...
  private void displayVerificationView(@NonNull String e164number, int callCountdown) {
    ...
    title.animate().translationX(-1 * title.getWidth()).setDuration(SCENE_TRANSITION_DURATION).setListener(new AnimationCompleteListener() {
      @Override
      public void onAnimationEnd(Animator animation) {
        title.setText(getString(com.example.altuncu.blocksignal.R.string.RegistrationActivity_verify_s, e164number));
        title.clearAnimation();
    ...
    subtitle.animate().translationX(-1 * subtitle.getWidth()).setDuration(SCENE_TRANSITION_DURATION).setListener(new AnimationCompleteListener() {
      @Override
      public void onAnimationEnd(Animator animation) {
        SpannableString subtitleDescription = new SpannableString(getString(com.example.altuncu.blocksignal.R.string.RegistrationActivity_please_enter_the_verification_code_sent_to_s, e164number));
        SpannableString wrongNumber         = new SpannableString(getString(com.example.altuncu.blocksignal.R.string.RegistrationActivity_wrong_number));
    ...
    fab.animate().rotationBy(-360f).setDuration(SCENE_TRANSITION_DURATION).setListener(new AnimationCompleteListener() {
      ...
      public void onAnimationEnd(Animator animation) {
        fab.clearAnimation();
        fab.setImageResource(com.example.altuncu.blocksignal.R.drawable.ic_textsms_24dp);
  ...
  private void displayPinView(String code, long lockedUntil) {
    title.animate().translationX(-1 * title.getWidth()).setDuration(SCENE_TRANSITION_DURATION).setListener(new AnimationCompleteListener() {
      @Override
      public void onAnimationEnd(Animator animation) {
        title.setText(com.example.altuncu.blocksignal.R.string.RegistrationActivity_registration_lock_pin);
        title.clearAnimation();
        title.setTranslationX(title.getWidth());
        title.animate().translationX(0).setListener(null).setInterpolator(new OvershootInterpolator()).setDuration(SCENE_TRANSITION_DURATION).start();
      }
    ...
    subtitle.animate().translationX(-1 * subtitle.getWidth()).setDuration(SCENE_TRANSITION_DURATION).setListener(new AnimationCompleteListener() {
      @Override
      public void onAnimationEnd(Animator animation) {
        subtitle.setText(com.example.altuncu.blocksignal.R.string.RegistrationActivity_this_phone_number_has_registration_lock_enabled_please_enter_the_registration_lock_pin);
        subtitle.clearAnimation();
        subtitle.setTranslationX(subtitle.getWidth());
        subtitle.animate().translationX(0).setListener(null).setInterpolator(new OvershootInterpolator()).setDuration(SCENE_TRANSITION_DURATION).start();
      }
    ...
    fab.animate().rotationBy(-360f).setDuration(SCENE_TRANSITION_DURATION).setListener(new AnimationCompleteListener() {
      ...
      public void onAnimationEnd(Animator animation) {
        fab.clearAnimation();
        fab.setImageResource(com.example.altuncu.blocksignal.R.drawable.ic_lock_white_24dp);
        fab.animate().rotationBy(-360f).setDuration(SCENE_TRANSITION_DURATION).setListener(null).start();
      }
    }).start();
  ...
  public void onEvent(FullBackupBase.BackupEvent event) {
    if (event.getCount() == 0) restoreBackupProgress.setText(com.example.altuncu.blocksignal.R.string.RegistrationActivity_checking);
    else                       restoreBackupProgress.setText(getString(com.example.altuncu.blocksignal.R.string.RegistrationActivity_d_messages_so_far, event.getCount()));
  }
  ...
  private class InformationToggleListener implements View.OnClickListener {
    ...
    public void onClick(View v) {
      if (informationView.getVisibility() == View.VISIBLE) {
        ...
        informationToggleText.setText(com.example.altuncu.blocksignal.R.string.RegistrationActivity_more_information);
      } else {
        informationView.setVisibility(View.VISIBLE);
        informationToggleText.setText(com.example.altuncu.blocksignal.R.string.RegistrationActivity_less_information);
      }
    }
  }
