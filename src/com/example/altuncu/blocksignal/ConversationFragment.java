...
import com.example.altuncu.blocksignal.ConversationAdapter.HeaderViewHolder;
import com.example.altuncu.blocksignal.ConversationAdapter.ItemClickListener;
import com.example.altuncu.blocksignal.contactshare.ContactUtil;
import com.example.altuncu.blocksignal.contactshare.SharedContactDetailsActivity;
...
import com.example.altuncu.blocksignal.database.loaders.ConversationLoader;
...
import com.example.altuncu.blocksignal.profiles.UnknownSenderView;
...
import com.example.altuncu.blocksignal.util.SaveAttachmentTask;
import com.example.altuncu.blocksignal.util.SaveAttachmentTask.Attachment;
import com.example.altuncu.blocksignal.util.StickyHeaderDecoration;
  ...
  implements LoaderManager.LoaderCallbacks<Cursor>
{
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle bundle) {
    final View view = inflater.inflate(com.example.altuncu.blocksignal.R.layout.conversation_fragment, container, false);
    list                 = ViewUtil.findById(view, android.R.id.list);
    composeDivider       = ViewUtil.findById(view, com.example.altuncu.blocksignal.R.id.compose_divider);
    scrollToBottomButton = ViewUtil.findById(view, com.example.altuncu.blocksignal.R.id.scroll_to_bottom_button);
    scrollDateHeader     = ViewUtil.findById(view, com.example.altuncu.blocksignal.R.id.scroll_date_header);
    ...
    topLoadMoreView    = (ViewSwitcher) inflater.inflate(com.example.altuncu.blocksignal.R.layout.load_more_header, container, false);
    bottomLoadMoreView = (ViewSwitcher) inflater.inflate(com.example.altuncu.blocksignal.R.layout.load_more_header, container, false);
  ...
  private void setCorrectMenuVisibility(Menu menu) {
    ...
    if (messageRecords.size() > 1) {
      menu.findItem(com.example.altuncu.blocksignal.R.id.menu_context_forward).setVisible(false);
      menu.findItem(com.example.altuncu.blocksignal.R.id.menu_context_reply).setVisible(false);
      menu.findItem(com.example.altuncu.blocksignal.R.id.menu_context_details).setVisible(false);
      menu.findItem(com.example.altuncu.blocksignal.R.id.menu_context_save_attachment).setVisible(false);
      menu.findItem(com.example.altuncu.blocksignal.R.id.menu_context_resend).setVisible(false);
    } else {
      MessageRecord messageRecord = messageRecords.iterator().next();

      menu.findItem(com.example.altuncu.blocksignal.R.id.menu_context_resend).setVisible(messageRecord.isFailed());
      menu.findItem(com.example.altuncu.blocksignal.R.id.menu_context_save_attachment).setVisible(!actionMessage                     &&
                                                                  messageRecord.isMms()              &&
                                                                  !messageRecord.isMmsNotification() &&
                                                                  ((MediaMmsMessageRecord)messageRecord).containsMediaSlide());

      menu.findItem(com.example.altuncu.blocksignal.R.id.menu_context_forward).setVisible(!actionMessage);
      menu.findItem(com.example.altuncu.blocksignal.R.id.menu_context_details).setVisible(!actionMessage);
      menu.findItem(com.example.altuncu.blocksignal.R.id.menu_context_reply).setVisible(!actionMessage             &&
                                                        !messageRecord.isPending() &&
                                                        !messageRecord.isFailed()  &&
                                                        messageRecord.isSecure());
    }
    menu.findItem(com.example.altuncu.blocksignal.R.id.menu_context_copy).setVisible(!actionMessage && hasText);
  }
  ...
  private void handleDeleteMessages(final Set<MessageRecord> messageRecords) {
    ...
    builder.setTitle(getActivity().getResources().getQuantityString(com.example.altuncu.blocksignal.R.plurals.ConversationFragment_delete_selected_messages, messagesCount, messagesCount));
    builder.setMessage(getActivity().getResources().getQuantityString(com.example.altuncu.blocksignal.R.plurals.ConversationFragment_this_will_permanently_delete_all_n_selected_messages, messagesCount, messagesCount));
    builder.setCancelable(true);

    builder.setPositiveButton(com.example.altuncu.blocksignal.R.string.delete, new DialogInterface.OnClickListener() {
      @Override
      public void onClick(DialogInterface dialog, int which) {
        new ProgressDialogAsyncTask<MessageRecord, Void, Void>(getActivity(),
                                                               com.example.altuncu.blocksignal.R.string.ConversationFragment_deleting,
                                                               com.example.altuncu.blocksignal.R.string.ConversationFragment_deleting_messages)
        {
          @Override
    ...
    SaveAttachmentTask.showWarningDialog(getActivity(), new DialogInterface.OnClickListener() {
      public void onClick(DialogInterface dialog, int which) {
        ...
        Toast.makeText(getActivity(),
                       getResources().getQuantityString(com.example.altuncu.blocksignal.R.plurals.ConversationFragment_error_while_saving_attachments_to_sd_card, 1),
  ...
  private class ConversationScrollListener extends OnScrollListener {
    ...
    ConversationScrollListener(@NonNull Context context) {
      this.scrollButtonInAnimation  = AnimationUtils.loadAnimation(context, com.example.altuncu.blocksignal.R.anim.fade_scale_in);
      this.scrollButtonOutAnimation = AnimationUtils.loadAnimation(context, com.example.altuncu.blocksignal.R.anim.fade_scale_out);
  ...
  private class ConversationFragmentItemClickListener implements ItemClickListener {
      ...
      new AsyncTask<Void, Void, Integer>() {
        ...
        protected void onPostExecute(Integer position) {
          ...
          if (position >= 0 && position < getListAdapter().getItemCount()) {
            ...
            Toast.makeText(getContext(), getResources().getText(com.example.altuncu.blocksignal.R.string.ConversationFragment_quoted_message_not_found), Toast.LENGTH_SHORT).show();
            if (position < 0) {
    ...
    public void onInviteSharedContactClicked(@NonNull List<Recipient> choices) {
      ...
      ContactUtil.selectRecipientThroughDialog(getContext(), choices, locale, recipient -> {
        CommunicationActions.composeSmsThroughDefaultApp(getContext(), recipient.getAddress(), getString(com.example.altuncu.blocksignal.R.string.InviteActivity_lets_switch_to_signal, "https://sgnl.link/1KpeYmF"));
      });
    }
  }
  ...
  private class ActionModeCallback implements ActionMode.Callback {
    ...
    public boolean onCreateActionMode(ActionMode mode, Menu menu) {
      ...
      inflater.inflate(com.example.altuncu.blocksignal.R.menu.conversation_context, menu);
      ...
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
        ...
        window.setStatusBarColor(getResources().getColor(com.example.altuncu.blocksignal.R.color.action_mode_status_bar));
      }
    ...
    public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
      switch(item.getItemId()) {
        case com.example.altuncu.blocksignal.R.id.menu_context_copy:
          handleCopyMessage(getListAdapter().getSelectedItems());
          actionMode.finish();
          return true;
        case com.example.altuncu.blocksignal.R.id.menu_context_delete_message:
          handleDeleteMessages(getListAdapter().getSelectedItems());
          actionMode.finish();
          return true;
        case com.example.altuncu.blocksignal.R.id.menu_context_details:
          handleDisplayDetails(getSelectedMessageRecord());
          actionMode.finish();
          return true;
        case com.example.altuncu.blocksignal.R.id.menu_context_forward:
          handleForwardMessage(getSelectedMessageRecord());
          actionMode.finish();
          return true;
        case com.example.altuncu.blocksignal.R.id.menu_context_resend:
          handleResendMessage(getSelectedMessageRecord());
          actionMode.finish();
          return true;
        case com.example.altuncu.blocksignal.R.id.menu_context_save_attachment:
          handleSaveAttachment((MediaMmsMessageRecord)getSelectedMessageRecord());
          actionMode.finish();
          return true;
        case com.example.altuncu.blocksignal.R.id.menu_context_reply:
  ...
  private static class ConversationDateHeader extends HeaderViewHolder {
    ...
    private ConversationDateHeader(Context context, TextView textView) {
      super(textView);
      this.animateIn  = AnimationUtils.loadAnimation(context, com.example.altuncu.blocksignal.R.anim.slide_from_top);
      this.animateOut = AnimationUtils.loadAnimation(context, com.example.altuncu.blocksignal.R.anim.slide_to_top);
